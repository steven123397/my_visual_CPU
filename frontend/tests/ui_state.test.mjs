...
test('buildTimelineRows highlights stalls and redirects', () => {
  const rows = buildTimelineRows([
    { summary: { cycle: 1 }, pipeline: { if: { text: 'lw' }, id: { text: 'add' }, ex: { text: '' }, mem: { text: '' }, wb: { text: '' }, flags: { stalled: true, redirected: false } } },
    { summary: { cycle: 2 }, pipeline: { if: { text: 'jal' }, id: { text: 'nop' }, ex: { text: 'beq' }, mem: { text: '' }, wb: { text: '' }, flags: { stalled: false, redirected: true } } },
  ]);

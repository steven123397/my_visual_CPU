...
struct AiAcceleratorProfileSummary {
    ...
    uint32_t last_submission_weight_tensor_count{0};
    uint32_t last_submission_constant_tensor_count{0};
    uint32_t last_submission_intermediate_tensor_count{0};
    uint32_t last_submission_scratchpad_budget_bytes{0};
    uint32_t last_submission_op_count{0};
    ...
    uint32_t last_submission_flags{0};
    ...
    uint32_t submission_queue_size_snapshot{0};
    uint32_t completion_queue_size_snapshot{0};
    uint32_t submission_head_snapshot{0};
    uint32_t submission_tail_snapshot{0};
    uint32_t completion_head_snapshot{0};
    uint32_t completion_tail_snapshot{0};
    bool queue_configured_snapshot{false};
...
struct AiActiveSubmissionState {
    ...
    AiShapeMode profile_shape_mode{AiShapeMode::Static};
    ...
    uint32_t profile_scratchpad_budget_bytes{0};
    uint32_t profile_op_count{0};
...
private:
    ...
    void update_profile_summary_submission_compile_contract();

...
constexpr uint64_t MSTATUS_FS_MASK = 0x3ULL << 13;
constexpr uint64_t MSTATUS_FS_OFF = 0x0ULL << 13;
constexpr uint64_t MSTATUS_FS_INITIAL = 0x1ULL << 13;
constexpr uint64_t MSTATUS_FS_CLEAN = 0x2ULL << 13;
constexpr uint64_t MSTATUS_FS_DIRTY = 0x3ULL << 13;

...
- `guest_supervisor_demo` 与 `kernel_alpha` 十条 demo 当前共同构成 Phase 1 核心 guest 门禁，回归收口口径见 [docs/design/regression_completion_criteria.md](../../docs/design/regression_completion_criteria.md)
